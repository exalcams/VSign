...
@Component({
  selector: 'app-tagdocument',
  templateUrl: './tagdocument.component.html',
  styleUrls: ['./tagdocument.component.scss'],
...
export class TagdocumentComponent implements OnInit {
  ...
  files: any;
  // file1:File;
  constructor(public dialog: MatDialog,private dialogRef:MatDialogRef<TagdocumentComponent>,
...
this.files=this.FileNames;
    ...
    const formData = new FormData();
     ...
     fd.sfile = dfile; 
      ...
      this.http.post<any>('http://192.168.0.25:5055/api/SignDoc/Upload',formData)
    .subscribe(ev => {
         fd.FDocID=ev.fileID;
          this.msg='success';
