...
import { Table, TagDetails } from './document-center';
...
sendRemainder2(docId: any): Observable<any> {
  return this.httpClient.get<any>("http://localhost:61067/api/SendRemainder/SendRemainderController2?id=" + docId);
}
sendEmail1(formdata: any) {
 
  console.log(formdata);
  return this.httpClient.post<any>(this.baseurl +"api/SendRemainder/SendTempUserCredentials", formdata);
}
}
