...
export class DocumentCenterComponent implements OnInit {
  ...
  constructor(private service: DashboardService1, private _snackBar: MatSnackBar, private router: Router, private fb: FormBuilder, public datepipe: DatePipe, private _authservice: AuthService) {
