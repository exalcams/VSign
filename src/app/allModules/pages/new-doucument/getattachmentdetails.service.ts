...
export class GetattachmentdetailsService {
  ...
  getMultipleUser(clientID){
    return this.httpClient.get(this.baseurl+"api/Master/GetMultipleUser?clientID="+clientID);
  }

  SendConfirmationEmail(files:FormData)
  {
    return this.httpClient.post<any>("http://localhost:61067/api/SendRemainder/sendEmail",files);
  }
