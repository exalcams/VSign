...
export class MasterService {
    ...
    constructor(
        ...
        this.VisgnURl ="http://localhost:57308";
    ...
    GetAllADusers():Observable<any>{
        return this._httpClient.get<any>(this.baseAddress+"api/Master/GetAllADusers");
    }
    ...
    GetAllReferences():Observable<Referencemodel[]|any>{
    return this._httpClient.get<Referencemodel[]>(this.VisgnURl+"api/ManageRef/GetAllRefs").pipe(catchError(this.errorHandler));;
    }

    CreateReference(ref:Referencemodel){
        return this._httpClient.post<Referencemodel>(this.VisgnURl+"api/ManageRef/CreateRef",ref).pipe(catchError(this.errorHandler));
    }

    UpdateReference(ref:Referencemodel){
        return this._httpClient.post<Referencemodel>(this.VisgnURl+"api/ManageRef/UpdateRef",ref).pipe(catchError(this.errorHandler));
    }
    DeleteReference(id:string){
        return this._httpClient.post<string>(this.VisgnURl+"api/ManageRef/DeleteRef",[id]).pipe(catchError(this.errorHandler));
    }
}
