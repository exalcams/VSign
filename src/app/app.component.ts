...
export class AppComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        mdIconRegistry.addSvgIcon('dashboardIcon', sanitizer.bypassSecurityTrustResourceUrl('/assets/images/Document_search.svg'));
        mdIconRegistry.addSvgIcon('newdocumentIcon', sanitizer.bypassSecurityTrustResourceUrl('/assets/images/NewDocument.svg'));
        mdIconRegistry.addSvgIcon('documentsearchIcon', sanitizer.bypassSecurityTrustResourceUrl('/assets/images/SearchDocument.svg'));
        mdIconRegistry.addSvgIcon('settingIcon', sanitizer.bypassSecurityTrustResourceUrl('/assets/images/SettingDocument.svg'));
        mdIconRegistry.addSvgIcon('repositoryIcon', sanitizer.bypassSecurityTrustResourceUrl('/assets/images/RepositoryDocument.svg'));
